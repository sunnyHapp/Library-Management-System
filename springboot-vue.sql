...
CREATE TABLE `book`  (
  ...
  `borrownum` int(11) NOT NULL DEFAULT 0 COMMENT '此书被借阅次数',
...
-- Records of book
-- ----------------------------
INSERT INTO `book` VALUES (9, '20211880115', '十万个为什么', 15.00, '苏格与', '温州大学出版社', '2024-12-05', '0', 18);
INSERT INTO `book` VALUES (10, '20211880119', '五万个为什么', 20.00, '聂家辉', '温州大学出版社', '2023-12-01', '1', 19);
INSERT INTO `book` VALUES (11, '20211880106', '一万个为什么', 16.00, '丁奕中', '温州大学出版社', '2023-12-02', '1', 13);
INSERT INTO `book` VALUES (12, '20211880114', '计算机操作系统', 32.00, '凌浩晨', '温州大学出版社', '2023-12-03', '1', 4);
INSERT INTO `book` VALUES (13, '20211880118', '伊索寓言', 25.00, '沈益威', '温州大学出版社', '2023-12-04', '1', 12);
INSERT INTO `book` VALUES (15, '20211880109', '格林童话', 20.00, '张超祥', '温州大学出版社', '2023-12-05', '1', 3);
INSERT INTO `book` VALUES (16, '20211880100', '图书管理系统', 188.00, 'SUNNY', '北京科技大学天津学院出版社', '2023-08-10', '0', 16);
INSERT INTO `book` VALUES (17, '20211880128', '和另一个自己谈谈心', 12.00, '\r\n武志红', '中国友谊出版公司', '2023-01-01', '1', 12);
...
-- ----------------------------
INSERT INTO `bookwithuser` VALUES (28, '20211880115', '十万个为什么', '孙晨彬', '2022-12-29 09:22:08', '2023-02-27 09:22:08', 0);
INSERT INTO `bookwithuser` VALUES (27, '20211880100', '图书管理系统', '借阅者', '2022-12-29 08:48:36', '2023-01-28 08:48:36', 2);
...
CREATE TABLE `lend_record`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1756061698 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of lend_record
-- ----------------------------
INSERT INTO `lend_record` VALUES (-2048151551, 21, '20211880119', '五万个为什么', '2023-01-01 13:38:36', '2024-05-13 13:05:27', '1', 19);
...
CREATE TABLE `user`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'sunny', 'sunny', '孙晨彬', '18888888888', '男', '北京科技大学天津学院30斋', 1, '1');
INSERT INTO `user` VALUES (21, 'user', 'user', '借阅者', '18888222222', '男', '北京科技大学', 2, '1');
INSERT INTO `user` VALUES (28, 'user1', 'user1', 'tom', '18888888444', '男', 'xxx', 2, '1');
